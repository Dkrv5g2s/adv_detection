...
def train_rf_detector(X_train, y_train, n_estimators=100, max_depth=None, random_state=42):
    """訓練Random Forest偵測器"""
...
def main():
    ...
    print("=== Random Forest-Based Adversarial Detection ===")
    print(f"Attack types: {ATTACK_TYPES}")
    print(f"Training samples: {TRAIN_SAMPLES}, Test samples: {TEST_SAMPLES}")
    print("Method: SHAP features → Random Forest classifier")
    ...
    # === 第二階段：訓練Random Forest偵測器 ===
    print("\n=== Phase 2: Training Random Forest detector ===")
    ...
    # === 第三階段：測試偵測效果 ===
    print("\n=== Phase 3: Testing Random Forest detector ===")
...
def print_results(seed, base_acc, detection_results, attack_effectiveness, attack_params):
    """列印最終結果"""
    print("\n" + "=" * 120)
    print("RANDOM FOREST-BASED DETECTION RESULTS SUMMARY")
    print("=" * 120)
