...
def main():
    ...
    print("\n" + "=" * 60)
    print("Experimental Settings (Single-Step AT with LB Loss)")
    print("=" * 60)
    ...
    pgd_path_rs, aa_path_rs = generate_and_save_adversarial_examples(
        model_rs, test_loader, device, 'rs_der_lb', epsilon=epsilon, adv_dir=adv_dir
    )

    print("\n" + "=" * 60)
    print("RS-DER+LB Evaluation (Final Checkpoint)")
    print("=" * 60)
    ...
    pgd_path_n, aa_path_n = generate_and_save_adversarial_examples(
        model_n, test_loader, device, 'n_der_lb', epsilon=epsilon, adv_dir=adv_dir
    )

    print("\n" + "=" * 60)
    print("N-DER+LB Evaluation (Final Checkpoint)")
    print("=" * 60)
    ...
    print("\n" + "=" * 60)
    print("Final Results Summary (DER + LB)")
    print("=" * 60)
    print(f"\nCIFAR-10 (ε = 8/255, 50 epochs, Single-Step)")
    print(f"{'Method':<20} {'Clean':<10} {'PGD-20':<10} {'AA':<10}")
    print("-" * 60)
    print(f"{'RS-DER+LB':<20} {clean_acc_rs:>9.2f} {pgd_acc_rs:>9.2f} {aa_acc_rs:>9.2f}")
    print(f"{'N-DER+LB':<20} {clean_acc_n:>9.2f} {pgd_acc_n:>9.2f} {aa_acc_n:>9.2f}")
    print("=" * 60)
